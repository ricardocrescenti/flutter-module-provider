...
export 'provider/map_consumer.dart';
...
export 'route/module_route_manager.dart';
export 'route/module_route_observer.dart';
//export 'route/module_route_outlet.dart';
export 'route/module_route_pattern.dart';