...
class _ComponentWidget<T extends Controller> extends State<Component> {
	...
	void initState() {
		...
		logger.log('Component ${widget.runtimeType} initialized');
	}
	...
	void didChangeDependencies() {
		...
		// get parent module
		module = context.dependOnInheritedWidgetOfExactType<InheritedModule>()!.module;
		...
		if (!_initialized) {
			...
			_futureInitialize = widget.initialize(context, controller) as Future<void>?;
	...
	void dispose() {
		...
		logger.log('Component ${widget.runtimeType} disposed');
	}
